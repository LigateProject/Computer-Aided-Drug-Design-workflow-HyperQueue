...
from ligate.pipelines.ligconv import LigConvParameters, LigConvPipelineParameters, ligconv_pipeline
from ligate.pipelines.ligconv.common import Edge, LigConvContext
from ligate.pipelines.ligconv.setup import load_ligen_output_data
...
ligen_output = load_ligen_output_data(
    "ligen/output/p38/protein_amber/protein.pdb",
    "ligen/output/p38/ligands_gaff2"
)
...
with LocalCluster() as cluster:
    ...
    edge_task_state = ligconv_pipeline(job, LigConvPipelineParameters(
        gmx=gmx,
        babel=babel,
        stage=stage,
        ctx=ligconv_ctx
